  ...
  const candidatosListaInicial = [
    {
      ...
      cargos: {
        cargos0: "Senador",
        cargos1: "Alcalde de Bogotá",
        cargos2: "Representante de la camara",
        cargos3: "Secretario De Relaciones Exteriores",
        cargos4: "Concejal de Zipaquirá",
        cargos5: "Personero de Zipaquirá",
      },
      formacion: {
        formacion0: "Economía",
        formacion1: "Estudios especializados en desarrollo",
      },
      logo,
      posicion: "Izquierda",
      encuestas: true,
    ...
    },
    {
      ...
      genero: "F",
      cargos: {
        cargos0: "Representante Student Travel Center",
        cargos1: "Directora de Asuntos Internacionales - Fiscalía",
        cargos2: "Representante a la camara",
        cargos3: "Senadora",
      },
      formacion: {
        formacion0: "Ciencia Política",
        formacion1: "Literatura e Historia",
      },
      logo: logo2,
      posicion: "Derecha",
      encuestas: true,
    ...
    },
    {
      ...
      genero: "F",
      cargos: {
        cargos0: "Director del Centro de Ciencia y Tecnología de Antioquia",
        cargos1:
          "Junta Directiva de la Fundación de Apoyo a la Universidad de Antioquia",
        cargos2: "Subdirector de El Colombiano",
        cargos3: "Alcaldía de Medellín",
        cargos4: "Gobernación de Antioquia",
      },
      formacion: {
        formacion0: "Matemáticas",
        formacion1: "PhD Matemáticas",
      },
      logo: logo3,
      posicion: "Centro",
      encuestas: false,
